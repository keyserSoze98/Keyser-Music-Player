...
import com.keysersoze.android.keysermusicplayer.databinding.FragmentNowPlayingBinding
...
class NowPlaying : Fragment() {
    ...
    private fun pauseMusic() {
        ...
        PlayerActivity.binding.nextBtnPA.setImageResource(R.drawable.play_icon)
