...
import com.keysersoze.android.keysermusicplayer.databinding.ActivitySettingsBinding
...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.sortBtn.setOnClickListener {
            val menuList = arrayOf("Recently Added", "Title", "File Size")
    ...
    private fun saveTheme(index: Int) {
        if (MainActivity.themeIndex != index) {
            ...
            builder.setTitle("Apply Theme")
                .setMessage("Do you want to apply theme and restart app?")
